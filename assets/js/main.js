...
let game = document.createTextNode("HOW SMART ARE YOU?")
titel.appendChild(game)
...
data.forEach(round => {
    ...
    let questionContent = document.createTextNode(round.question)
    questions.appendChild(questionContent)
    div.appendChild(questions)

    let choice = round.choice
    choice.forEach(choice => {
        let button = document.createElement("button")
        let newButton = document.createTextNode(choice)
        let textButton = newButton
        ...
        button.addEventListener("click", (e) => {
            ...
            if (choice === round.answer) {
                ...
                let rightText = document.createTextNode("YEAH! That´s right!")
                ...
                let wrongText = document.createTextNode("Wrong ! Try again ! ")
